...
# Decorator for measuring time within a application

# measuring time method, time.perf_counter()
# Todo check out video for 25 habits not to use in python video
...
def euler(derivative,
          ...
          x_limit: float) -> tuple:
    """
    Euler's formula is required in order to
    create an approximation for the function.
    y1 = y0 + m*(x1-x0)
    m = dy/dx,
